  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.text}>Error occurred in adding the item!</Text>
      </View>
      <View style={styles.buttons}>
        <TouchableOpacity style={[styles.button, styles.addButton]} onPress={() => navigation.navigate('AddItems')}>
